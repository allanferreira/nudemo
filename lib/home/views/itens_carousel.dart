  ...
  static List<Widget> itensList(BuildContext context) {
    return [
      ...
      GestureDetector(
        ...
        onDoubleTap: () => Routes(context).navigatorPush(context, '/nuconta/'),
        onLongPress: () => Routes(context).navigatorPush(context, '/nuconta/'),
      ),
      GestureDetector(
        child: Container(
          key: Key('/rewards/'),
        ...
        onDoubleTap: () => Routes(context).navigatorPush(context, '/rewards/'),
        onLongPress: () => Routes(context).navigatorPush(context, '/rewards/'),
      ),
    ];
  }
}
